...
function exportChartImage(chart, fileName = "SplitChart.png") {
...
document.getElementById("export-chart-btn").addEventListener("click", () => {
    exportChartImage(splitChart);
});

document.getElementById("export-data-btn").addEventListener("click", () => {
    exportChartData(SplitData); // Replace SplitData with your filtered data if needed
});
